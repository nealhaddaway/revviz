...
#' columns), updating the disaplyed row totals in the summary line.
...
#' @param titlefont_size Font size for the title text. Default is 20.
...
#' @param tablefont_size Font size for the table text. Default is 20.
